...
`);
        ...
        <h3 class="accordion-title owner-toggle">Published by: <strong>${owner.full_name}</strong> <a href="https://git.door43.org/${owner.name}" class="globe" target="_blank"><i class="fa fa-globe" aria-hidden="true" title="View Organization page on DCS"></i></a>
            <i class="accordion-icon">
                <div class="line-01"></div>
                <div class="line-02"></div>
            </i>
